...
const StudioPage: React.FC = () => {
  ...
  if (error) {
    ...
    <div className="h-full w-full flex flex-col bg-gray-900 text-white">
      {/* Top Assets Bar */}
      <div className="bg-gradient-to-r from-gray-800/80 to-gray-700/80 border-b border-gray-600/30 p-3">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-2">
                {projectData?.moodboard?.map((imageUrl, index) => (
                  <div key={index} className="flex items-center gap-2 p-2 bg-gray-600/30 rounded-lg hover:bg-gray-600/50 transition-colors cursor-pointer">
                    <img src={imageUrl} alt={`Asset ${index + 1}`} className="w-8 h-6 object-cover rounded" />
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex gap-2">
                  {Object.entries(projectData.voiceoverUrls).map(([sceneIndex, audioUrl]) => (
                    <div key={sceneIndex} className="flex items-center gap-2 p-2 bg-gray-600/30 rounded-lg hover:bg-gray-600/50 transition-colors cursor-pointer">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-2">
              <button className="p-2 bg-indigo-600/30 hover:bg-indigo-600/50 rounded-lg transition-colors text-xs text-white">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
              </button>
              <button className="p-2 bg-purple-600/30 hover:bg-purple-600/50 rounded-lg transition-colors text-xs text-white">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-9 0h10m-10 0a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2" />
                </svg>
              </button>
              <button className="p-2 bg-pink-600/30 hover:bg-pink-600/50 rounded-lg transition-colors text-xs text-white">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </button>
              <button className="p-2 bg-orange-600/30 hover:bg-orange-600/50 rounded-lg transition-colors text-xs text-white">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Timeline */}
      <div className="bg-gradient-to-r from-gray-800/80 to-gray-700/80 rounded-2xl p-4 border border-gray-600/30 backdrop-blur-sm flex-shrink-0">
