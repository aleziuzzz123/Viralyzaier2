...
const StudioPage: React.FC = () => {
  ...
  return (
    <div className="h-full w-full flex bg-gray-900 text-white">
      ...
      <div className="w-64 bg-gradient-to-b from-gray-800/80 to-gray-700/80 border-r border-gray-600/30 p-3 flex flex-col gap-3 overflow-y-auto">
        <div className="flex items-center gap-2 mb-3">
          <svg className="w-5 h-5 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
          </svg>
          <h2 className="text-lg font-bold text-white">Assets & Tools</h2>
        </div>
        
        {/* Project Assets */}
        <div className="bg-gray-700/50 rounded-lg p-3 border border-gray-600/30">
          <h3 className="text-sm font-semibold text-white mb-2">Project Assets</h3>
        ...
        {projectData?.voiceoverUrls && Object.keys(projectData.voiceoverUrls).length > 0 && (
          <div className="bg-gray-700/50 rounded-lg p-3 border border-gray-600/30">
            <h3 className="text-sm font-semibold text-white mb-2">Audio Tracks</h3>
            <div className="space-y-2">
      ...
      {/* Main Editor Area */}
      <div className="flex-1 flex flex-col p-2 gap-4 min-w-0">
      {isLoading && (
